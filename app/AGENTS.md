...
- Prompt sinh Quiz mặc định phải yêu cầu `stem`, nội dung lựa chọn và explanation bằng tiếng Việt kể cả khi chunk có nội dung tiếng Anh, đồng thời giữ nguyên thuật ngữ tiếng Anh, viết tắt, tên riêng, product/API name và code identifier lấy từ nguồn.
