...
- Khi override một dependency ESM vào chuỗi CommonJS runtime, phải kiểm tra tương thích bằng đúng Node major của Docker/CI và có regression test load dependency qua Jest; postinstall bridge phải idempotent và fail-closed khi contract thay đổi.
